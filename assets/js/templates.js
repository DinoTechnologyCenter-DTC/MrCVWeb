import{z as r,A as n,v as i,S as o,h as d,t as c,B as v}from"./main.js";function p(e){return e.kind==="letter"?`<div class="cv-sheet tpl-letter cv-zoom">${n(v)}</div>`:`<div class="cv-sheet tpl-${e.slug} cv-zoom">${i(o)}</div>`}function f(e){const a=e.useLink||`new-cv.html?template=${e.slug}`;return`
